...
{% include image.html name="-02" caption="Live Essences complete offer of wellness shot drinks" %}
...
{% include image.html name="-03" caption="Live Essences lab in Bali" %}
...
{% include image.html name="-04" caption="Live Essences healthy stomach drink" %}
...
{% include image.html name="-07" caption="Live Essences processes  plants into drinks" %}
...
{% include image.html name="-05" caption="Live Essences and some of the ingredients used" %}
...
{% include image.html name="-06" caption="Live Essences source locally from organic faming facilities" %}
...
{% include image.html name="-08" caption="Live Essences skin oils" %}
