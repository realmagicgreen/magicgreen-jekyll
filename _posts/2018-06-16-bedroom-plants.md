...
{% include image.html name="-02" caption="Areca palm" %}
...
{% include image.html name="-05" caption="Aloe Vera" %}
...
{% include image.html name="-06" caption="Mother-in-law's tongue, also called Snake plant" %}
...
{% include image.html name="-04" caption="Peepal tree" %}
...
{% include image.html name="-07" caption="Orchids" %}
...
{% include image.html name="-08" caption="Spider Plant" %}
...
{% include image.html name="-09" caption="Lavender" %}
...
{% include image.html name="-10" caption="Gardenia" %}
...
{% include image.html name="" caption="English Ivy" %}
...
{% include image.html name="-12" caption="Jasmine" %}
...
{% include image.html name="-13" caption="Rosemary" %}
